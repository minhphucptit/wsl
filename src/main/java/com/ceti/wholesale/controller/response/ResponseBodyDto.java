package com.ceti.wholesale.controller.response;

import com.ceti.wholesale.common.enums.ResponseCode;
...
public class ResponseBodyDto<E> {
    ...
    public ResponseBodyDto(List<E> items, ResponseCode code, String message, long totalItems) {
        this.code = code;
        this.message = message;
        this.items = items;
