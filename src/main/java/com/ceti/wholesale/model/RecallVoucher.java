...
public class RecallVoucher {
    ...
    @Column(name = "delivery_voucher_no")
    private String deliveryVoucherNo;

    @Column(name = "delivery_voucher_id")
    ...
    @Column(name = "truck_license_plate_number", nullable = false, length = 32)
